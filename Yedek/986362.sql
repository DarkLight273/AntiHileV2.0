...
--
-- Anamakine: localhost
-- Üretim Zamanı: 25 Ağu 2016, 01:55:26
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  PRIMARY KEY (`NO`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci AUTO_INCREMENT=94 ;
