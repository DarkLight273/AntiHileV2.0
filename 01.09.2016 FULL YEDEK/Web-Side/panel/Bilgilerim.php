...
include 'session.php';
GirisLazim($link);
$BaslangicTarih = date('d.m.Y',$_SESSION['kisisel']['Sunucu_BZ']);
$SonTarih = date('d.m.Y',$_SESSION['kisisel']['Sunucu_BZ']);
$ToplamLisansGun = round(abs($_SESSION['kisisel']['Sunucu_BZ'] - $_SESSION['kisisel']['Sunucu_SZ'])/60/60/24);
?>
<!DOCTYPE html>
<html>
<head>
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									...
									<p>
										...
										<small>Lisansınız <?php echo $ToplamLisansGun;?> Gündür Aktif.</small>
									</p>
								</li>
								<!-- Menu Body -->
								<!-- Menu Footer-->
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="alert alert-info alert-dismissible">
								...
								Sadece Bilgi Amaçlıdır.<br>Herhangi Bir Değişiklik Talebi için Desteğe Başvurun.
							</div>
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" value="<?php echo $BaslangicTarih?>" disabled="">
								<span class="glyphicon glyphicon-resize-horizontal input-group-addon" style="position: initial;"></span>
								<input type="text" class="form-control" disabled="" value="<?php echo $SonTarih?>">
								<span class="input-group-addon"><i class="fa fa-hourglass"></i></span>
							</div>
							<br>
							<div class="input-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" disabled="" value="<?php echo $_SESSION['kisisel']['Minecraft_Nick'] ?>">
							</div>
							<br>
							<div class="input-group">
