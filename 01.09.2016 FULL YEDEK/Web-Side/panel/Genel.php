...
include 'session.php';
GirisLazim($link);
# Sayfa üzerinde Kullanılan Değerler
$ToplamLisansGun = round(abs($_SESSION['kisisel']['Sunucu_BZ'] - $_SESSION['kisisel']['Sunucu_SZ'])/60/60/24);
$KalanLisansGun = round(abs(time() - $_SESSION['kisisel']['Sunucu_SZ'])/60/60/24);
?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="row"">
				...
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-yellow">
						...
						<div class="inner">
							<h3><?php echo $KalanLisansGun;?><small> Gün</small></h3>
							<p>Lisans Durumu</p>
						</div>
						<a href="<?php echo $link->bilgilerim;?>" class="small-box-footer">
							Bilgilerim <i class="fa fa-arrow-circle-right"></i>
						</a>
					</div>
				</div>
			</div>
