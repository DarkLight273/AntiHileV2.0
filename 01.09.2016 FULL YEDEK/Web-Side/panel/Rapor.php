...
<body class="skin-blue fixed">
		...
		<div class="main-sidebar">
			...
			<div class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="<?php echo $link->log;?>"><span>Anti-Hile Rapor</span></a></li>
				</ul><!-- /.sidebar-menu -->
	...
	<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Anti-Hile Rapor</li>
			</ol>
		</section>
		<section class="content">
		<div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Rapor Dosyası</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form">
                <div class="form-group">
                  <textarea class="form-control" rows="15">Yükleniyor...</textarea>
                </div>
                </form>
            </div>
            <!-- /.box-body -->
